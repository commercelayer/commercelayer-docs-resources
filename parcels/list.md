...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of parcels, send a `GET` request to the `/api/parcels` endpoint.
...
The list of parcels can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
