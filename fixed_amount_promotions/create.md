...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new fixed amount promotion, send a `POST` request to the `/api/fixed_amount_promotions` endpoint, passing the resource arguments in the request body.
