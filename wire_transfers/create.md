...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new wire transfer, send a `POST` request to the `/api/wire_transfers` endpoint, passing the resource arguments in the request body.
