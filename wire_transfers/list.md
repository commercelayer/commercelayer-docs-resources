...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of wire transfers, send a `GET` request to the `/api/wire_transfers` endpoint.
...
The list of wire transfers can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
