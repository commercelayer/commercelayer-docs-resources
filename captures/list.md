...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of captures, send a `GET` request to the `/api/captures` endpoint.
...
The list of captures can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
