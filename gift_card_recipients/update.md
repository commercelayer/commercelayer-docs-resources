...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing gift card recipient, send a `PATCH` request to the `/api/gift_card_recipients/:id` endpoint, where `id` is the ID of the resource that you want to update.
