...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing customer group, send a `PATCH` request to the `/api/customer_groups/:id` endpoint, where `id` is the ID of the resource that you want to update.
