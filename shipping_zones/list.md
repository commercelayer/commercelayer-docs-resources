...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of shipping zones, send a `GET` request to the `/api/shipping_zones` endpoint.
...
The list of shipping zones can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
