...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of SKU lists, send a `GET` request to the `/api/sku_lists` endpoint.
...
The list of SKU lists can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
