...
To update an existing fixed price promotion, send a `PATCH` request to the `/api/fixed_price_promotions/:id` endpoint, where `id` is the ID of the resource that you want to update.
