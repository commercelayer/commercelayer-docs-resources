...
To update an existing coupon recipient, send a `PATCH` request to the `/api/coupon_recipients/:id` endpoint, where `id` is the ID of the resource that you want to update.
