...
To create a new billing info validation rule, send a `POST` request to the `/api/billing_info_validation_rules` endpoint, passing the resource arguments in the request body.
