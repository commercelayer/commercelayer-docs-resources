...
To create a new in stock subscription, send a `POST` request to the `/api/in_stock_subscriptions` endpoint, passing the resource arguments in the request body.
