...
To update an existing google geocoder, send a `PATCH` request to the `/api/google_geocoders/:id` endpoint, where `id` is the ID of the resource that you want to update.
...
**PATCH** https://<i></i>yourdomain.commercelayer.io/api/google_geocoders/:id
