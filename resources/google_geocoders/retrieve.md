...
To fetch a single google geocoder, send a `GET` request to the `/api/google_geocoders/:id` endpoint, where `id` is the ID of the resource that you want to retrieve.
