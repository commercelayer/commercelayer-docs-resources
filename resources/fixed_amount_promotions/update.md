...
To update an existing fixed amount promotion, send a `PATCH` request to the `/api/fixed_amount_promotions/:id` endpoint, where `id` is the ID of the resource that you want to update.
...
**PATCH** https://<i></i>yourdomain.commercelayer.io/api/fixed_amount_promotions/:id
