...
To fetch a single manual gateway, send a `GET` request to the `/api/manual_gateways/:id` endpoint, where `id` is the ID of the resource that you want to retrieve.
