...
To update an existing taxjar account, send a `PATCH` request to the `/api/taxjar_accounts/:id` endpoint, where `id` is the ID of the resource that you want to update.
