...
To fetch a single braintree gateway, send a `GET` request to the `/api/braintree_gateways/:id` endpoint, where `id` is the ID of the resource that you want to retrieve.
