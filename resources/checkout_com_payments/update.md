...
To update an existing checkout com payment, send a `PATCH` request to the `/api/checkout_com_payments/:id` endpoint, where `id` is the ID of the resource that you want to update.
