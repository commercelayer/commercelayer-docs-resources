...
To update an existing free shipping promotion, send a `PATCH` request to the `/api/free_shipping_promotions/:id` endpoint, where `id` is the ID of the resource that you want to update.
