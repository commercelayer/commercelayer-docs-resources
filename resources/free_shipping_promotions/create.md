...
To create a new free shipping promotion, send a `POST` request to the `/api/free_shipping_promotions` endpoint, passing the resource arguments in the request body.
