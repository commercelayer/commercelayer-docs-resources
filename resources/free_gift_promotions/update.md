...
To update an existing free gift promotion, send a `PATCH` request to the `/api/free_gift_promotions/:id` endpoint, where `id` is the ID of the resource that you want to update.
...
**PATCH** https://<i></i>yourdomain.commercelayer.io/api/free_gift_promotions/:id
