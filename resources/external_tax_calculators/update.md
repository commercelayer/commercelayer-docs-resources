...
To update an existing external tax calculator, send a `PATCH` request to the `/api/external_tax_calculators/:id` endpoint, where `id` is the ID of the resource that you want to update.
