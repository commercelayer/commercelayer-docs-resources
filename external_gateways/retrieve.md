...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a single external gateway, send a `GET` request to the `/api/external_gateways/:id` endpoint, where `id` is the ID of the resource that you want to retrieve.
