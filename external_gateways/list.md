...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of external gateways, send a `GET` request to the `/api/external_gateways` endpoint.

## Request

**GET** https://yourdomain.commercelayer.io**/api/external\_gateways**
...
The list of external gateways can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
