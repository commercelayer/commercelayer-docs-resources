...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new return, send a `POST` request to the `/api/returns` endpoint, passing the resource arguments in the request body.
