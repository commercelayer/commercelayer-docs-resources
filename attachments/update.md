...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing attachment, send a `PATCH` request to the `/api/attachments/:id` endpoint, where `id` is the ID of the resource that you want to update.
