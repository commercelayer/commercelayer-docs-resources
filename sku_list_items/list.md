...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of SKU list items, send a `GET` request to the `/api/sku_list_items` endpoint.
...
The list of SKU list items can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
