...
| attributes.**tax_amount_cents** | `integer` | The collected tax amount, otherwise calculated as total amount cents - discount cent * tax rate, in cents. |
| attributes.**tax_amount_float** | `float` | The collected tax amount, otherwise calculated as total amount cents - discount cent * tax rate, float. |
| attributes.**formatted_tax_amount** | `string` | The collected tax amount, otherwise calculated as total amount cents - discount cent * tax rate, formatted. |
