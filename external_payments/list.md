...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of external payments, send a `GET` request to the `/api/external_payments` endpoint.
...
The list of external payments can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
