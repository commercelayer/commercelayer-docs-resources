...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing parcel line item, send a `PATCH` request to the `/api/parcel_line_items/:id` endpoint, where `id` is the ID of the resource that you want to update.
