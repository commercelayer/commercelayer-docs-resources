...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new google geocoder, send a `POST` request to the `/api/google_geocoders` endpoint, passing the resource arguments in the request body.

## Request

**POST** https://yourdomain.commercelayer.io**/api/google\_geocoders**
