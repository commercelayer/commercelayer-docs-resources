...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of promotion rules, send a `GET` request to the `/api/promotion_rules` endpoint.
...
The list of promotion rules can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
