...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of paypal gateways, send a `GET` request to the `/api/paypal_gateways` endpoint.
...
The list of paypal gateways can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
