...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing customer payment source, send a `PATCH` request to the `/api/customer_payment_sources/:id` endpoint, where `id` is the ID of the resource that you want to update.
