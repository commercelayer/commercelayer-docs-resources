...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of shipments, send a `GET` request to the `/api/shipments` endpoint.
...
The list of shipments can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
