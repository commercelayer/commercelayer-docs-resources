...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of bundles, send a `GET` request to the `/api/bundles` endpoint.
...
The list of bundles can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
