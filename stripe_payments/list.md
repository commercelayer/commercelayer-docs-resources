...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of stripe payments, send a `GET` request to the `/api/stripe_payments` endpoint.
...
The list of stripe payments can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
