...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new customer address, send a `POST` request to the `/api/customer_addresses` endpoint, passing the resource arguments in the request body.
