...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing line item option, send a `PATCH` request to the `/api/line_item_options/:id` endpoint, where `id` is the ID of the resource that you want to update.
