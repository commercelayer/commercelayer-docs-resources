...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing merchant, send a `PATCH` request to the `/api/merchants/:id` endpoint, where `id` is the ID of the resource that you want to update.
