...
To [update](https://docs.commercelayer.io/developers/updating-resources) an existing adyen payment, send a `PATCH` request to the `/api/adyen_payments/:id` endpoint, where `id` is the ID of the resource that you want to update.
