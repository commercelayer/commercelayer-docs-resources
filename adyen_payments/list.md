...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a collection of adyen payments, send a `GET` request to the `/api/adyen_payments` endpoint.
...
The list of adyen payments can be [sorted](https://docs.commercelayer.io/developers/sorting-results) by the following attributes:
