...
To [fetch](https://docs.commercelayer.io/developers/fetching-resources) a single adyen payment, send a `GET` request to the `/api/adyen_payments/:id` endpoint, where `id` is the ID of the resource that you want to retrieve.
