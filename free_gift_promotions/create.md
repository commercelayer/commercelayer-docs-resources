...
To [create](https://docs.commercelayer.io/developers/creating-resources) a new free gift promotion, send a `POST` request to the `/api/free_gift_promotions` endpoint, passing the resource arguments in the request body.

## Request

**POST** https://yourdomain.commercelayer.io**/api/free\_gift\_promotions**
